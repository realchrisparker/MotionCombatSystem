 ...
 * Date: 10-18-2025
 * =============================================================================
 * HitReactionDataTableFactory.h
 * Factory that creates a UDataTable preconfigured with FMCS_HitReaction as the row struct.
 */
...
#include "HitReactionDataTableFactory.generated.h"

extern EAssetTypeCategories::Type MotionCombatSystemCategory;

UCLASS()
class MOTIONCOMBATSYSTEMEDITOR_API UHitReactionDataTableFactory : public UFactory
{
    GENERATED_BODY()

public:
    // Constructor
    UHitReactionDataTableFactory()
    {
        bCreateNew = true;
        bEditAfterNew = true;
    ...
    virtual UObject* FactoryCreateNew(UClass* Class, UObject* InParent, FName Name, EObjectFlags Flags, UObject* Context, FFeedbackContext* Warn) override
    {
        ...
        NewTable->RowStruct = FMCS_HitReaction::StaticStruct();
    ...
    {
        return NSLOCTEXT("HitReactionDataTableFactory", "DisplayName", "Hit Reaction Data Table");
    }
    ...
    {
        return NSLOCTEXT("HitReactionDataTableFactory", "ToolTip", "Create a new Motion Combat System Hit Reaction Data Table.");
    }
};
